...
document.addEventListener("DOMContentLoaded", () => {
        ...
        commentRef.on('child_added', function(snapshot) {
            ...
            const dados = {
                ...
                nome: comentario.nome,
                 isAdmin: comentario.isAdmin === true || comentario.isAdmin === "true"
            };
    ...
    function addCommentToScreen(commentText, timestamp, commentKey, nome = null, isAdminComment = false) {
        ...
        // ✅ Só exibe o nome se for comentário de admin
        ...
        // Botão de deletar só aparece se o usuário for admin logado
        if (isAdmin) {
            ...
            deleteButton.onclick = () => {
                ...
                displayComments(); // Atualiza os comentários
            };
            commentContainer.appendChild(deleteButton);
        }
    
        // Adiciona o comentário no topo se for de admin, senão no final
        if (isAdminComment) {
