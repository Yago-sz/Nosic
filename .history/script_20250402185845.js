...
function alterarImagemCapa(caminhoImagem) {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        // Função para obter o ID único da música
        function getMusicId() {
        ...
        form.addEventListener('submit', (event) => {
            ...
            displayComments(); // Atualiza os comentários na tela
        });
    
        // Atualiza os comentários quando a música muda
        player.addEventListener('loadeddata', displayComments);
    
        // Carrega os comentários da primeira música ao iniciar
        displayComments();
    });