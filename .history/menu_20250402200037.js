...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let commentSection = document.querySelector(".Coment");

    form.addEventListener("submit", function (event) {
        event.preventDefault(); // Impede o recarregamento da página

        let commentText = document.getElementById("inputText").value.trim();
        if (commentText === "") return; // Impede envio de comentários vazios

        let commentContainer = document.getElementById("commentPost");
        ...
        // 🔥 Garante que a tela permaneça na seção de comentários após enviar
        setTimeout(() => {
