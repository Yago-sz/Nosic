...
function alterarImagemCapa(caminhoImagem) {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    // Função para obter um ID único da música baseada no src do player
    function getMusicId() {
    ...
    function displayComments() {
        commentPost.innerHTML = "<h5>Comentários</h5>"; // Limpa a seção antes de adicionar novos
    ...
    form.addEventListener('submit', (event) => {
        ...
        displayComments(); // Atualiza a exibição dos comentários
    });

    // Atualiza os comentários sempre que a música mudar
